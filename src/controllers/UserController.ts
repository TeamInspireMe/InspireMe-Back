			...
			.then(userToRemove => {
				...
				userRepository
					...
					.then(result => {
						...
						const data: Mail = {
							from: 'InspireMe <InspireMe@InspireMe.org>',
							to: userToRemove.email,
							subject: 'Unsubscription',
							text: `Hey ${userToRemove.username}! We are worried to confirm that your account has been successfully deleted. We hope to see you back soon!`,
						};
